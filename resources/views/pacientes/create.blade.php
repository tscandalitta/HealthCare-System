...
<div class="container">
    <form method="POST" action="/pacientes">
        ...
        <hr>
        <div class="form-group row">
            <label for="inputEstudios" class="col-lg-2 col-form-label">Adjuntar estudios</label>
            <div class="col-lg-10">
                <input type="file" class="form-control-file" id="inputEstudios" name="estudios" multiple>
            </div>
        </div>
